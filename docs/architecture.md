...
│       ├── Mcp/                        # MCP server: 10 [McpServerToolType] classes = 38 tools (29 mirroring AiAgent* surface + 8 P0 decision/risk read tools + 1 daily digest; mapped at /mcp, ApiKey scheme)
