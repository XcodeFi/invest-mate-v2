...
│       ├── Mcp/                        # MCP server: 12 [McpServerToolType] classes = 54 tools (29 mirroring AiAgent* surface + 8 P0 decision/risk + 1 daily digest + 8 P1 analytics + 8 P2 market research; mapped at /mcp, ApiKey scheme)
