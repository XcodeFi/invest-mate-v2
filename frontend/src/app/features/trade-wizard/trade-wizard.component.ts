      ...
      <div class="bg-white rounded-xl shadow-lg p-6 min-h-[400px]">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">% Rủi ro / giao dịch</label>
        ...
        <div *ngIf="currentStep === 4">
          ...
          <div class="max-w-2xl mx-auto space-y-4">
            ...
            <!-- Technical Setup -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Thiết lập kỹ thuật</label>
