    ...
    <div class="container mx-auto px-4 py-6">
      ...
      <div *ngIf="showCreateForm" class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Setup kỹ thuật <sup class="text-violet-400 font-bold">1</sup></label>
            <textarea [(ngModel)]="newJournal.technicalSetup" rows="2"
              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              placeholder="RSI, MACD, support/resistance..."></textarea>
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Trạng thái cảm xúc <sup class="text-pink-400 font-bold">2</sup></label>
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Mức tự tin (1-10) <sup class="text-amber-400 font-bold">3</sup></label>
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Đánh giá sau giao dịch <sup class="text-blue-400 font-bold">4</sup></label>
        ...
        <div class="mt-4 rounded-lg bg-gray-50 border border-gray-200 px-4 py-3 text-xs text-gray-500 space-y-1">
          <div><sup class="text-violet-400 font-bold">1</sup> <strong>Setup kỹ thuật (Technical Setup):</strong> Các tín hiệu phân tích kỹ thuật đã nhận diện trước khi vào lệnh: mô hình nến, đường MA, RSI, MACD, vùng hỗ trợ/kháng cự, Bollinger Bands…</div>
          <div><sup class="text-pink-400 font-bold">2</sup> <strong>Trạng thái cảm xúc:</strong> Ghi nhận tâm lý lúc vào lệnh để phân tích sau. <strong>FOMO</strong> (Fear Of Missing Out) = sợ bỏ lỡ cơ hội, vào lệnh khi giá đã chạy xa mà không theo kế hoạch.</div>
          <div><sup class="text-amber-400 font-bold">3</sup> <strong>Mức tự tin (Confidence):</strong> Thang điểm 1–10 đánh giá độ chắc chắn của tín hiệu. Điểm thấp (&lt;5) = tín hiệu yếu, nên giảm size hoặc bỏ qua lệnh.</div>
          <div><sup class="text-blue-400 font-bold">4</sup> <strong>Đánh giá sau giao dịch (Post-trade Review):</strong> Ghi lại kết quả thực tế so với kế hoạch: lệnh đúng/sai chiến lược, cảm xúc có ảnh hưởng không, rút kinh nghiệm gì.</div>
        </div>
