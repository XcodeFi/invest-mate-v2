...
- Tests: verify thật DB prod (tài khoản test, mã HPG) 8/8 qua API + 22 mục qua browser. 1.738 test backend + 171 test frontend pass, không regression (số đo tại thời điểm mở PR).
